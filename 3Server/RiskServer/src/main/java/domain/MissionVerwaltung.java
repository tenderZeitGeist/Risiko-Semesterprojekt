...
public class MissionVerwaltung {
    ...
    public MissionVerwaltung() {
        ...
        missionList.add(new CountryMissions(null, "Conquer 12 Countries of your \nchoice with at least 2 forces on each one", 2, 12, 2));
        ...
        missionList.add(new ContinentMissions(null, "Conquer The Outer Rim, Delta Quad \nand a third system of your choice!", 8, new int[]{3, 2, 0}));
        missionList.add(new ContinentMissions(null, "Conquer Dagobah, The Colonies \nand a system of your choice!", 9, new int[]{1, 5, 0}));
